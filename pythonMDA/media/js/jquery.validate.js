...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Pro favor corrija este campo.",
		...
		creditcard: "Por favor ingrese un número de tarjeta de credito válido.",
		equalTo: "Por favor ingrese el mismo valor otra vez.",
		maxlength: $.validator.format( "El campo no puede tener más de {0} characteres." ),
		minlength: $.validator.format( "El campo no puede tener menos de {0} characteres." ),
		rangelength: $.validator.format( "El campo debe tener entre {0} y {1} characteres." ),
		range: $.validator.format( "Por favor ingrese un número entre {0} y {1}." ),
		max: $.validator.format( "Por favor ingrese un número menor o igual a {0}." ),
		min: $.validator.format( "Por favor ingrese un número mayor o igual a {0}." )
	},
